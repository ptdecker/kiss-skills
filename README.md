...
| [review-pr](skills/review-pr/SKILL.md)           | `/kiss:review-pr [owner/repo PR \| PR-URL]` | Review a peer's PR — analyze changes, build observations interactively, and create a pending GitHub review          |
